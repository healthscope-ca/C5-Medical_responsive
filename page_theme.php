...
namespace Application\Theme\MedicalResponsive;
...
class PageTheme extends \Concrete\Core\Page\Theme\Theme implements ThemeProviderInterface
{
    public function registerAssets()
    {
		...
		$this->providesAsset('javascript', 'bootstrap/dropdown'); // fixes conflict that stops block "Design and Custom Template" items from showing their dialogs.
    ...
    {
        return t('Healthscope Medical');
    }

    public function getThemeDescription()
    {
        return t('Responsive Healthscope Medical theme for Concrete5.');
    }
